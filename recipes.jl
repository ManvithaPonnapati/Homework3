...
datafiles    = ["results.txt"]  # If provided, use first file for training, second for dev, others for test.
togenerate   = 20000           # If non-zero generate given number of characters.
